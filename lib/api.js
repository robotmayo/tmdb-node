...
function TmdbApi(key){
    ...
    createGenericChainMethod(this, config.endpoints.movie.collection, 'collection', without('collection',Object.keys(config.endpoints.collection)))
...
function createGenericChainMethod(api, uri,firstNode, methodList){
    api[firstNode] = function(id,opts,callback){
        if(!opts) {
